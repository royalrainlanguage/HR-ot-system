    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .has-overtime {
            ...
            box-shadow: 0 0 24px rgba(239, 68, 68, 0.3) !important;
        }
        .has-overtime::before { background: radial-gradient(circle at center, rgba(239, 68, 68, 0.2) 0%, transparent 70%); opacity: 1; }
        ...
        .day-is-reported.has-overtime { background: linear-gradient(135deg, rgba(99, 102, 241, 0.25) 0%, rgba(239, 68, 68, 0.25) 100%) !important; }

        .reported-indicator { position: absolute; top: 12px; right: 12px; background: var(--primary); color: white; font-size: 10px; font-weight: 700; padding: 4px 8px; border-radius: 6px; z-index: 2; box-shadow: 0 2px 8px rgba(99, 102, 241, 0.4); }
        .deferred-indicator { position: absolute; top: 38px; right: 12px; background: rgba(245, 158, 11, 0.95); color: white; font-size: 9px; font-weight: 700; padding: 3px 6px; border-radius: 5px; z-index: 2; }
            ...
            <div class="sidebar">
                ...
                <div class="info-card">
                    ...
                    <div class="legend-grid">
                        ...
                        <div class="legend-item">
                            <div class="legend-color" style="background: linear-gradient(135deg, rgba(239, 68, 68, 0.3) 0%, rgba(239, 68, 68, 0.15) 100%); border: 2px solid rgba(239, 68, 68, 0.6);"></div>
